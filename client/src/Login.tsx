      ...
      <div id="login-container">
        ...
        <form onSubmit={buttonPressed}>
          <div>
            <label>
              AWS Access Key ID:
              <input disabled={!usingElectron} type="text" placeholder="Enter your access key ID" className="login-input" value={accessKey} onChange={(e) => setAccessKey(e.target.value)} />
            </label>
          </div>
          ...
          <div>
            <label>
              ...
              <div className="passwordContainer">
                <input disabled={!usingElectron} type={hidePassword ? 'password' : 'text'} className="login-input" placeholder="Enter your secret access key" value={secretKey} onChange={(e) => setSecretKey(e.target.value)} />
          ...
          <div >
            <label>
              Cluster Name:
              <input disabled={!usingElectron} type="text" placeholder="Enter the Cluster's name" className="login-input" value={clusterName} onChange={(e) => setClusterName(e.target.value)} />
            </label>
          </div>
          ...
          <div>
            <label>
              Region:
              <input disabled={!usingElectron} type="text" placeholder="Enter the Cluster's region" className="login-input" value={regionName} onChange={(e) => setRegionName(e.target.value)} />
            </label>
          </div>
