...
/**
   ...
   * @remarks If you intend to add additional Drawers, you will need to add additional selectors and reducers here and in the store.
   */
export enum DrawerType { traceView }
...
export const selectTraceTableDrawerIsOpen = (state: RootState) => state.traceDrawer.isOpen;
